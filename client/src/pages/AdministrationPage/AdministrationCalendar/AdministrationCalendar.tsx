...
import { getMonthData } from 'src/pages/AdministrationPage/AdministrationCalendar/useAdministrationCalendar';
...
import AdministrationOrderModal from 'src/pages/AdministrationPage/AdministrationOrderModal/AdministrationOrderModal';
const weekDayNames = [
  'Понедельник',
  'Вторник',
  'Среда',
            ...
            {cell === undefined ? (
              ...
              <div className={styles.Calendar__cells__ordersCell}>
                ...
                {cell.orders.length > 0 && (
                  <div className={styles.Calendar__cells__ordersCell__statuses}>
                    {cell.orders.map((ord, ordIdx) => (
                      <div
                        className={cx(styles.Calendar__cells__orderStatus, {
                          ...
                          completed:
                            ord.status === OrderProcessingStatusEnum.COMPLETED,
                          rejected:
