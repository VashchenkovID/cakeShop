...
const AdministrationTypesModalsFilling = ({ filling, setFilling, onSave, onClose, title, isDelete, }) => {
    ...
    return (React.createElement(React.Fragment, null, !isDelete ? (React.createElement("div", { className: styles.Container },
        React.createElement(Text, { size: "2xl" }, "\u0421\u043E\u0437\u0434\u0430\u043D\u0438\u0435 \u043D\u0430\u0447\u0438\u043D\u043A\u0438"),
        React.createElement(TextField, { size: "s", form: "round", label: "Наименование", placeholder: "Введите наименование", value: filling.name, onChange: (e) => setFilling((prevState) => {
        ...
        React.createElement(Text, null,
            "\u0412\u044B \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0442\u0435\u043B\u044C\u043D\u043E \u0445\u043E\u0442\u0438\u0442\u0435 \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u043D\u0430\u0447\u0438\u043D\u043A\u0443 ",
            filling.name,
            " ?"),
        React.createElement("div", { className: styles.Container__actions },
            React.createElement(Button, { size: "s", label: "Отмена", onClick: onClose }),
...
//# sourceMappingURL=AdministrationTypesModalsFilling.js.map